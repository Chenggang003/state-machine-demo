...
@Component
@Slf4j
public class DeliverAction implements Action<OrderStatusEnum, OrderEventEnum> {
    ...
    public void execute(StateContext<OrderStatusEnum, OrderEventEnum> context) {
        ...
        try {
            ...
            context.getExtendedState().getVariables().put(Exception.class, new RuntimeException("订单发货异常"));
